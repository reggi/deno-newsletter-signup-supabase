export * from "https://deno.land/x/nano_jsx@v0.0.34/mod.ts";
...
export function renderSSR(render: CallableFunction, options?: SSRSettings) {
  ...
  return html({ body, head, footer, styleTag })
}
